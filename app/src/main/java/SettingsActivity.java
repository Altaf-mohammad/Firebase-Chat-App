    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    mProgressDialog.setMessage( "Plz wait for a while..." );
                                ...
                                uploadTask.addOnCompleteListener( new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                                        ...
                                        if (thumb_task.isSuccessful()){
                                            ...
                                            mUserDatabase.updateChildren(update_hashMap ).addOnCompleteListener( new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if(task.isSuccessful()){
                                                        ...
                                                        Toast.makeText( SettingsActivity.this, "Profile pic uploading", Toast.LENGTH_LONG ).show();
                                                    }
                                            ...
                                            Toast.makeText( SettingsActivity.this, "Error in Loading Thumbnail", Toast.LENGTH_LONG ).show();
                                            mProgressDialog.dismiss();
